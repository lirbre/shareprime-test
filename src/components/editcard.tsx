...
export const EditCard = ({ image, title, id }: ItemProps) => {
  ...
  return (
    <div
      ...
      className="flex h-full w-full cursor-pointer flex-col items-center justify-between gap-4 border border-[#000]/20 p-2.5 shadow-md shadow-[#000]/20 md:h-[90px] md:flex-row md:gap-0"
    >
